...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        layout_number.addWidget(button_multiply, 1, 3)
        layout_number.addWidget(button_minus, 2, 3)
        layout_number.addWidget(button_plus, 3, 3)

        # =, clear, backspace 버튼 생성
        button_equal = QPushButton("=")
        button_clear = QPushButton("C")  # Use "C" for clear instead of "Clear"
        button_clearE = QPushButton("CE")
        button_backspace = QPushButton("<-")  # Use "<-" for backspace
        ...
        layout_clear_equal.addWidget(button_clearE, 0, 2)
        layout_clear_equal.addWidget(button_equal, 0, 0)
